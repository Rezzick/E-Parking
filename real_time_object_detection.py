...
# initialize the variables needed to send queries from the program 
	...
	for i in np.arange(0, detections.shape[2]):
		...
		if confidence > args["confidence"]:
			...
			if CLASSES[idx] == "car":
				...
				VACANCY = 0
				TCP_MESSAGE = (LOTNUM,SPACENUM,VACANCY)
				MESSAGE = ",".join(map(str,TCP_MESSAGE))
