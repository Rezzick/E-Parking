...
//$con->close();
$query = "SELECT vacant FROM eParking.parking_lot_1";
$results = array();
...
<br>
    <button class="button" onclick="location.href='destroysesh.php'" style="vertical-align:middle"><span>Continue </span></button>
